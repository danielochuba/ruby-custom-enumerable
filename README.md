...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone https://github.com/danielochuba/ruby-custom-enumerable.git
  ```
...
To get a local copy up and running cloning this repo `https://github.com/danielochuba/ruby-custom-enumerable.git`.

### Prerequisites

There are no known prerequisites to run this project.
If you encounter any issues trying to run it, please feel free to
[open a ticket](https://github.com/danielochuba/ruby-custom-enumerable/issues) to let me know and i will work on it to the best
of my abilities
...
`https://github.com/danielochuba/ruby-custom-enumerable.git`

or

`https://github.com/danielochuba/ruby-custom-enumerable.git` <-- _Only if you have [SSH keys configured](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) on your GitHub account_.
...
Feel free to check the [issues page](https://github.com/danielochuba/ruby-custom-enumerable/issues).
